...
weekly_data_csv = "../data/fantrax_data/fantrax.weekly.all_data_combined.no_double_gws.new_positions.dgw_bug_fix.csv"
...
write.csv(x = all_combined_df, file = "../data/fantrax_data/new_positions.weekly_data.xFpts_epl_2019_2020.csv")
...
write.csv(x = summary_combined_xfpts_df, file = "../data/fantrax_data/new_positions.xFpts_epl_2019_2020.csv")
```
