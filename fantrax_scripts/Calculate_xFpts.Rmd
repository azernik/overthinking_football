...
write.csv(x = all_combined_df, file = "../data/fantrax_data/weekly_data.xFpts_epl_2019_2020.csv")
...
write.csv(x = summary_combined_xfpts_df, file = "../data/fantrax_data/xFpts_epl_2019_2020.csv")
```
