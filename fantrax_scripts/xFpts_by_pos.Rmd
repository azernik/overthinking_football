...
#load all player data for fbref.com
weekly_data_csv = "../data/fantrax_data/archive/weekly.all_data_combined.no_double_gws.csv"
yearly_data_csv = "../data/fantrax_data/archive/yearly.all_data_combined.csv"
